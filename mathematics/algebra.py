...
def summation(*args):
    """Summation returns the sum of multiple integers or element-wise sum of multiple lists of integers."""
    if not args:
...
def factorial(*args):
    ...
    if len(args) != 1:
        raise ValueError("One argument is required: a single non-negative integer or a list of non-negative integers.")
    value = args[0]
    # Single integer case
...
def log(*args):
    ...
    if len(args) != 1:
        raise ValueError("Exactly one argument is required: a non-negative number or a list of non-negative numbers.")
    value = args[0]
    # Single number case
...
def sum_natural_numbers(*args):
    ...
    if len(args) != 1:
        raise ValueError("Exactly one argument is required: a non-negative integer or a list of non-negative integers.")
    value = args[0]
